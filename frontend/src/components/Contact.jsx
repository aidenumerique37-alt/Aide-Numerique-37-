...
const Contact = () => {
  ...
  useEffect(() => {
    axios.get(`${BACKEND_URL}/api/admin/content`)
      .then(res => { if (res.data.contact) setContent(res.data.contact); })
      .catch(() => {});
  }, []);
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-french-blue via-french-blue to-sky-blue dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 dark:border-t dark:border-gray-800 text-white transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ── Ligne principale : infos + formulaire ── */}
        <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="!font-semibold !text-xl !text-[#F7F7F7]">{contactInfo.location}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="!font-semibold !text-xl !text-[#F7F7F7]">7j/7 — du lundi au dimanche, 8h30 – 20h</div>
          ...
          {/* Colonne droite — formulaire V2 */}
          <div>
            <ContactFormV2 />
          </div>
        </div>

        {/* ── Bloc centré : carte + réseaux ── */}
        <div className="mt-16 flex flex-col items-center gap-10">

          {/* Google Map */}
          <div className="w-full max-w-3xl rounded-xl overflow-hidden shadow-lg border border-white/20">
            <iframe
          ...
          <div className="flex flex-col items-center gap-4">
            <h3 className="text-base font-bold uppercase tracking-widest text-white/70">Suivez-moi sur les réseaux</h3>
            <div className="flex gap-4">
              <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer"
                className="w-14 h-14 flex items-center justify-center rounded-lg transition-all duration-300 hover:scale-110 hover:bg-white/30 !bg-[rgba(0,26,255,0.3)]">
                <Facebook size={28} />
              </a>
              <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer"
                className="w-14 h-14 flex items-center justify-center rounded-lg transition-all duration-300 hover:scale-110 hover:bg-white/30 !bg-[rgba(234,66,170,0.3)]">
                <Instagram size={28} />
              </a>
              <a href={socialLinks.google} target="_blank" rel="noopener noreferrer"
                className="w-14 h-14 flex items-center justify-center rounded-lg transition-all duration-300 hover:scale-110 hover:bg-white/30 !bg-[rgba(255,131,0,0.3)]">
