    ...
    >
      ...
      <div className="px-4 pb-3">
        <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
          {accepted && 'Google Analytics est activé. Vous pouvez modifier votre choix.'}
          {refused  && 'Cookies analytiques refusés. Vous pouvez modifier votre choix.'}
          {!accepted && !refused && 'Vous n\'avez pas encore défini vos préférences.'}
        </p>
        {(accepted || refused) && (
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Préférences cookies"
        aria-expanded={open}
        style={{ position: 'fixed', bottom: '20px', right: '20px', zIndex: 99998 }}
        className={`
